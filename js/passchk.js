...
function ShowStats()
{
   e = document.getElementById('passchk_pass');
   if (! e)
   {
      return;
   }
   	
   var pass = document.frm1.passchk_pass.value;
  ...
  // r += "<b>Length:</b>  " + pass.length + "<br>\n";
   ...
   if (pass.length > 1)
   {
	 ...
	 aidx = bidx;
      ...
      if (bits < 28)
      {
         r += "<span class='passcheck_weak'>weak</span>";
	...
	// r += "keep out the average person.<br>\n";
      ...
      {
         r += "<span class='passcheck_moderate'>moderate</span>";
	...
	// r += "crack it.  (Depends greatly on implementation!)<br>\n";
      ...
      {
         r += "<span class='passcheck_strong'>strong</span>";
